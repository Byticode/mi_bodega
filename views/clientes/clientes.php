  ...
  <main class="app-main">
    <div class="max-w-5xl mx-auto space-y-6">
      ...
      <div class="card p-5">
        ...
        <form class="grid grid-cols-1 sm:grid-cols-3 gap-3" action="<?= url('clientes/crear') ?>" method="POST">
          ...
          <tbody>
            ...
            <?php foreach ($clientes as $cliente): ?>
              <tr>
                ...
                <td class="text-right">
                  <a href="<?= url('clientes/editar/' . $cliente['cliente_id']) ?>" class="btn-icon" aria-label="Editar cliente">
