  ...
  <main class="app-main">
    <div class="max-w-3xl mx-auto space-y-6">
      ...
      <div class="card p-5">
        ...
        <form class="flex flex-col sm:flex-row gap-3" action="<?= url('categorias/crear') ?>" method="POST">
          ...
          <tbody>
            <?php foreach ($categorias as $categoria): ?>
              <tr>
                ...
                <td class="text-right">
                  <a href="<?= url('categorias/editar/' . $categoria['categorias_id']) ?>" class="btn-icon" aria-label="Editar categoría">
