...
?>
  ...
  <main class="flex-1 p-6 space-y-6 max-w-2xl mx-auto">
    <div class="flex items-center space-x-3">
      <a href="proveedores.html" class="p-2 rounded-lg bg-white border border-gray-200 text-gray-600 hover:bg-gray-100">
    ...
    <form class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-4" onsubmit="event.preventDefault();">
      <div>
        ...
        <input type="text" value="Distribuidora Central" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-olive">
      </div>
      <div>
        <label class="block text-xs font-semibold text-gray-700 mb-1">Teléfono</label>
        <input type="text" value="0414-1234567" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-olive">
      </div>

      <div class="pt-4 border-t border-gray-100 flex justify-end space-x-3">
        <a href="proveedores.html" class="px-4 py-2 border border-gray-300 rounded-lg text-xs font-semibold text-gray-600">Cancelar</a>
