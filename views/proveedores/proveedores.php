  ...
  <main class="flex-1 p-6 space-y-6 max-w-4xl mx-auto">
    ...
    <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
      ...
      <form class="grid grid-cols-1 sm:grid-cols-3 gap-3" onsubmit="event.preventDefault();">
        <input type="text" placeholder="Nombre Comercial" class="px-3 py-2 border border-gray-300 rounded-lg text-xs focus:outline-none focus:border-olive">
        <input type="text" placeholder="Teléfono" class="px-3 py-2 border border-gray-300 rounded-lg text-xs focus:outline-none focus:border-olive">
      ...
      <table class="w-full text-left text-xs">
        ...
        <tbody class="divide-y divide-gray-100">
          <tr class="hover:bg-gray-50">
            <td class="p-3 font-medium text-gray-900">Distribuidora Central</td>
            <td class="p-3">0414-1234567</td>
            <td class="p-3 text-right">
              <a href="proveedores-editar.html?id=1" class="inline-block p-1.5 text-gray-500 hover:text-olive hover:bg-gray-100 rounded-md">
