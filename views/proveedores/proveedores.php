  ...
  <main class="app-main">
    <div class="max-w-3xl mx-auto space-y-6">
      ...
      <div class="card p-5">
        ...
        <form class="flex flex-col sm:flex-row gap-3" action="<?= url('proveedores/crear') ?>" method="POST">
          ...
          <tbody>
            ...
            <?php foreach ($proveedores as $proveedor): ?>
              <tr>
                ...
                <td class="text-right">
                  <a href="<?= url('proveedores/editar/' . $proveedor['proveedor_id']) ?>" class="btn-icon" aria-label="Editar proveedor">
