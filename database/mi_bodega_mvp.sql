...
--
-- Host: localhost
-- Generation Time: Aug 06, 2026 at 08:34 AM
...
(1, '', 'Refresco Fanta Toronja 2L', 2.00, 6, 4, 10.00, 10),
(2, NULL, 'Mortadela De Pollo 1Kg', 1.00, 8, 2, 3.00, 0);
...
--
-- Dumping data for table `surtido_detalles`
--
...
--
ALTER TABLE `categorias`
  MODIFY `categorias_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `surtidos`
  MODIFY `surtido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
