...
<aside class="w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col justify-between p-4 fixed left-0 top-0 bottom-0 z-10">
    <div class="space-y-6">
      ...
      <nav class="space-y-1">
        <a href="index.php?controller=posController&action=listar" class="flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-100">
        ...
        <a href="index.php?controller=inventarioController&action=listar" class="flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-100">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
          <span>Inventario</span>
        </a>
        <a href="index.php?controller=ventasController&action=listar" class="flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-100">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
          <span>Ventas</span>
        </a>
        <a href="index.php?controller=surtidosController&action=listar" class="flex items-center space-x-3 px-4 py-2.5 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-100">
        ...
        <div class="relative pt-2">
          ...
          <div id="configMenu" class="pl-8 pr-2 py-1 space-y-1">
            <a href="index.php?controller=productosBaseController&action=listar" class="flex items-center space-x-2.5 px-3 py-2 text-xs font-semibold text-olive bg-olive-light rounded-md">
            ...
            <a href="index.php?controller=credencialesController&action=listar" class="flex items-center space-x-2.5 px-3 py-2 text-xs font-medium text-gray-600 rounded-md hover:bg-gray-100 hover:text-gray-900">
            ...
            <a href="index.php?controller=proveedoresController&action=listar" class="flex items-center space-x-2.5 px-3 py-2 text-xs font-medium text-gray-600 rounded-md hover:bg-gray-100 hover:text-gray-900">
            ...
            <a href="index.php?controller=categoriasController&action=listar" class="flex items-center space-x-2.5 px-3 py-2 text-xs font-medium text-gray-600 rounded-md hover:bg-gray-100 hover:text-gray-900">
            ...
            <a href="index.php?controller=clientesController&action=listar" class="flex items-center space-x-2.5 px-3 py-2 text-xs font-medium text-gray-600 rounded-md hover:bg-gray-100 hover:text-gray-900">
