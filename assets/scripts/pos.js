...
(function () {
  ...
  function filtrar() {
    ...
    if (contador) contador.textContent = visibles === 1 ? '1 producto' : visibles + ' productos';
  }
  ...
  function pintar() {
    ...
    if (!carrito.length) {
      ...
      carrito.forEach(function (item) {
        ...
        fila.className = 'pos-line flex justify-between items-center border-b border-gray-100 py-2 text-xs gap-2';
        ...
        qty.className = 'flex items-center border border-gray-200 rounded overflow-hidden';

        var menos = document.createElement('button');
        menos.type = 'button';
        menos.className = 'px-2 py-0.5 bg-gray-100 hover:bg-gray-200 text-xs font-bold text-gray-600';
        ...
        mas.type = 'button';
        mas.className = 'px-2 py-0.5 bg-gray-100 hover:bg-gray-200 text-xs font-bold text-gray-600';
